...
import static com.example.android.popularmoviesstagetwo.data.MovieContract.MovieEntry.TABLE_NAME;
...
public class MovieProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, MovieContract.PATH_FAVORITE, CODE_MOVIE);

        matcher.addURI(authority, MovieContract.PATH_FAVORITE + "/#", CODE_MOVIE_WITH_ID);
